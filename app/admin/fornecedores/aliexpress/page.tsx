...
export default function AliExpressImportPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="font-playfair text-2xl text-amber-100">Importar via AliExpress</h1>
                  ...
                  <div className="p-3 flex flex-col flex-1">
                    ...
                    <div className="mt-auto space-y-1">
                      <div className="flex justify-between text-[11px]">
                        <span className="text-amber-800">Custo AE:</span>
                      ...
                      <div className="flex justify-between text-[11px]">
                        ...
                        <span className="text-amber-600">{(product.listedNum ?? 0).toLocaleString()}</span>
                      </div>
                    </div>
